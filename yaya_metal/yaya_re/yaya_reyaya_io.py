...
# read lammps ase  ase.io.lammpsdata.read_lammps_data(fd, style = 'atomic') will crush
def ase_read_data(fileobj, Z_of_type=None, style="full", sort_by_id=False, units="metal"):
